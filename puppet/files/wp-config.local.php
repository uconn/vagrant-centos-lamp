 ...
 */
$server_name = 'd71h113.pr.uconn.edu'; // $_SERVER['SERVER_NAME'];
if (!defined('WP_SITEURL')) {
	define('WP_SITEURL', 'http://' . $server_name . ':8089/wordpress');
}
if (!defined('WP_HOME')) {
	define('WP_HOME',    'http://' . $server_name . ':8089');
}
if (!defined('WP_CONTENT_DIR')) {
	define('WP_CONTENT_DIR', dirname(__FILE__) . '/content');
}
if (!defined('WP_CONTENT_URL')) {
	define('WP_CONTENT_URL', 'http://' . $server_name . ':8089/content');
}
